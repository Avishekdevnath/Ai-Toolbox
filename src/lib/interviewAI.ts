...
export interface InterviewQuestion {
  id: string;
  category: 'technical' | 'behavioral' | 'problem-solving' | 'industry-specific';
...
Make the question specific, relevant, and challenging for the ${difficulty} level. Include 3-5 expected keywords that indicate a good answer. Provide 2 sample answers that demonstrate different levels of expertise.`;
}
