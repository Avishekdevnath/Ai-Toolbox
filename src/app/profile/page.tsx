    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {profile && !profile.hasSecurityQuestions && (
            <Card className="mb-6 border-amber-200 bg-amber-50">
              <CardContent className="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between">
                <div className="space-y-1">
                  <h2 className="text-lg font-semibold text-amber-900">Set up recovery questions</h2>
                  <p className="text-sm text-amber-800">
                    Add 3 to 5 security questions so you can recover your account or change your password
                    without email verification.
                  </p>
                </div>
                <Button type="button" onClick={() => router.push('/dashboard/settings/security')}>
                  Configure Questions
                </Button>
              </CardContent>
            </Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    <span className="ml-auto text-xs text-gray-500">
                      {profile.hasSecurityQuestions ? 'Configured' : 'Action Needed'}
                    </span>
                  </Button>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium">Recovery Questions</h4>
                          <p className="text-sm text-gray-600">
                            {profile.hasSecurityQuestions
                              ? 'Configured and ready for password recovery'
                              : 'Configure 3 to 5 questions to finish account recovery setup'}
                          </p>
                        </div>
                      </div>
                      <Button
