...
export async function GET(
  ...
  try {
    console.log('🔍 Getting admin user:', params.adminId);
    ...
    // Validate ObjectId
    if (!ObjectId.isValid(params.adminId)) {
    ...
    const admin = await AdminUser.findById(params.adminId).select('-password');
    if (!admin) {
...
export async function PUT(
  ...
  try {
    console.log('🔍 Updating admin user:', params.adminId);
    ...
    const admin = await AdminUser.findById(params.adminId);
    if (!admin) {
      console.log('❌ Admin user not found');
      return NextResponse.json(
        { success: false, error: 'Admin user not found' },
...
export async function DELETE(
  ...
  try {
    console.log('🔍 Deleting admin user:', params.adminId);
    ...
    // Delete admin
    await AdminUser.findByIdAndDelete(params.adminId);
