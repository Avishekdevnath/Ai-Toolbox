      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg text-[13px] text-slate-700 placeholder-slate-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none"
          />
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button onClick={onClear} className="flex-1 border border-slate-200 hover:bg-slate-50 text-slate-600 text-[13px] font-medium px-3 py-2 rounded-lg transition-colors">
            Clear
          </button>
        </div>
      </div>
