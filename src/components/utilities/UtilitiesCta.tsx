...
interface UtilitiesCtaProps {
  className?: string;
}

export default function UtilitiesCta({ className = '' }: UtilitiesCtaProps) {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Explore our AI tools and discover more ways to accelerate your workflow.
          </p>
